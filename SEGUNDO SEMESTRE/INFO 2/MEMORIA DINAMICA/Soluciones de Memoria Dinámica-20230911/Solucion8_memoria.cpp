...
int main(int argc, char *argv[]) {
	...
	do{
		...
		cout<<"a. Reserva de memoria e introducción de datos enteros"<<endl;
		cout<<"b. Agregar reserva de memoria e introducción de nuevos datos enteros"<<endl;
		...
		case 'b':
			...
			cin>>cant_plus; 
			ptr=(int*)realloc(ptr,(cant_plus+cant)*sizeof(int));
